...
export default function App() {
  ...
  const [fontsLoaded, fontError] = useFonts({
    ...
    'AlbertSans_300Light': require('@expo-google-fonts/albert-sans/300Light.ttf'),
    'AlbertSans_400Regular': require('@expo-google-fonts/albert-sans/400Regular.ttf'),
    'AlbertSans_500Medium': require('@expo-google-fonts/albert-sans/500Medium.ttf'),
    'AlbertSans_600SemiBold': require('@expo-google-fonts/albert-sans/600SemiBold.ttf'),
    'AlbertSans_700Bold': require('@expo-google-fonts/albert-sans/700Bold.ttf'),
    'AlbertSans_800ExtraBold': require('@expo-google-fonts/albert-sans/800ExtraBold.ttf'),
    'Cairo_300Light': require('@expo-google-fonts/cairo/300Light.ttf'),
    'Cairo_400Regular': require('@expo-google-fonts/cairo/400Regular.ttf'),
    'Cairo_500Medium': require('@expo-google-fonts/cairo/500Medium.ttf'),
    'Cairo_600SemiBold': require('@expo-google-fonts/cairo/600SemiBold.ttf'),
    'Cairo_700Bold': require('@expo-google-fonts/cairo/700Bold.ttf'),
    'Cairo_800ExtraBold': require('@expo-google-fonts/cairo/800ExtraBold.ttf'),
  });
