...
export const en: TranslationKeys = {
  common: {
    ...
    welcomeTitle: 'Welcome to Visitor App',
  ...
  visitor: {
    ...
    idType: 'Visitor ID Type',
    idNumber: 'Visitor ID Number',
  ...
  form: {
    ...
    endTime: 'End Time',
    startTimeReadOnly: 'Start time is set to approval time and cannot be changed',
  ...
  status: {
    ...
    waitingAcceptance: 'Awaiting Visitor',
    visitorPending: 'Awaiting Visitor Response',
    visitorAccepted: 'Visit Approved',
  ...
  actions: {
    ...
    editServicesDescription: 'Update end time and optional services for this visit',
  ...
  notifications: {
    ...
    upcomingVisitReminderTitle: 'Upcoming Visit',
    upcomingVisitReminderMessage: '{{visitorName}} arrives in about 15 minutes',
    ...
    templates: {
      ...
      parking_assigned: {
        ...
        message: 'Parking Required',
      },
      parking_full: {
        title: 'Parking Not Required',
        message: 'Parking Not Required',
      },
      buffet_new_request: {
      ...
      valet_new_request: {
        ...
        message: 'New valet request for {{visitorName}}',
      },
      valet_task_assigned: {
  ...
  settings: {
    ...
    testNotificationHint: 'Requires a native build (EAS) for push notifications to work on physical devices.',
  ...
  dashboard: {
    ...
    kpiLoadError: 'Unable to load dashboard KPIs.',
    kpiAccessError: 'Your dashboard access has changed. Please sign in again.',
    currentlyOnPremises: 'Currently on premises',
    thisWeek: 'This Week',
    last7Days: 'Last 7 days',
    walkIns: 'Walk-Ins',
    allVisitorsList: 'Visitor Directory',
  ...
  errors: {
    ...
    meetingRoomLoading: 'Meeting rooms are still loading. Please wait before submitting.',
    meetingRoomCheckFailed: 'Meeting room availability could not be checked. Please retry before submitting.',
    hostEmployeeLoading: 'Employee list is still loading. Please wait before submitting.',
    duplicateCheckLoading: 'Checking for duplicate bookings. Please wait before submitting.',
    duplicateCheckFailed: 'Duplicate bookings could not be checked. Please retry before submitting.',
    meetingRoomConflict: 'That room is no longer available. Please choose another room.',
    ...
    duplicateInviteTitle: 'Duplicate Invitation',
    duplicateInviteSameEmployee: 'This guest is already scheduled to visit on this date and time. Please edit or delete the existing invitation before creating a new one.',
    duplicateInviteDifferentEmployee: 'This guest is already scheduled to visit on this date and time.',
    invalidNationalId: 'National ID must be exactly 10 digits',
    invalidIqama: 'Iqama must be up to 10 digits',
    invalidPassport: 'Passport must be 6-12 alphanumeric characters',
    invalidDriverLicense: 'Driver\'s License must be exactly 10 digits',
  },
  splash: {
  ...
  invitation: {
    ...
    visitorAccepted: 'Visit Approved',
    visitorDeclined: 'Visitor Declined',
    parkingDecision: 'Parking',
    requiredParking: 'Parking required',
    notRequiredParking: 'Parking not required',
    visitorDecides: 'Let visitor decide',
    requiredParkingDesc: 'Parking will be arranged for the visitor',
    notRequiredParkingDesc: 'No parking will be arranged for this visit',
    visitorDecidesDesc: 'Visitor will choose whether they need parking',
  },
  reception: {
  ...
  parking: {
    ...
    expectedVisitors: 'Expected Visitors',
    withCarInfo: 'With Car Info',
    pendingCarInfo: 'Pending Car Info',
    checkedIn: 'Checked In',
    readOnlyNote: 'Read-only monitoring. Parking operations managed externally.',
    noParking: 'Parking Not Required',
    needsParking: 'Parking Required',
    awaitingVisitorDecision: 'Awaiting visitor decision',
  ...
  buffet: {
    ...
    locationNamePlaceholder: 'e.g., Executive Dining Room',
    locationNameRequired: 'Location name is required',
    building: 'Building',
    buildingPlaceholder: 'e.g., Main Building',
    floor: 'Floor',
    floorPlaceholder: 'e.g., 5th Floor',
    capacity: 'Capacity',
  ...
  admin: {
    ...
    enableAutomatedReminders: 'Enable automated reminders and auto-cancel',
    afterOfficeHoursStart: 'after office hours start',
    afterFirstReminder: 'after first reminder',
    afterSecondReminder: 'after second reminder',
    minutes: 'minutes',
    hours: 'hours',
    integrationsHealth: 'Integrations Health',
    ...
    upcoming: 'Upcoming',
    upcomingAccessibility: 'Visit starts soon',
  ...
  visitorInvite: {
    ...
    parkingNotAvailable: 'No parking provided',
  ...
  reports: {
    ...
    totalAllTime: 'Total Visitors (All Time)',
    totalPeriod: 'Visitors in Selected Period',
    ...
    successWithCount: '{{count}} records downloaded successfully',
    error: 'Download failed. Please try again.',
    summaryUnavailable: 'Visitor totals unavailable — the server could not load summary data.',
    excludesCancelled: 'Excludes cancelled & auto-cancelled',
    totalRecordsPeriod: 'Total Records in Period',
    totalRecordsAllTime: 'Total Records (All Time)',
    allStatuses: 'All statuses — matches downloaded report',
    exportAuditNote: 'The exported report includes all visit statuses (including cancelled and auto-cancelled) for a complete audit record. The KPI cards above show active visits only.',
  },
  calendar: {
    syncedToOutlook: 'Synced to Outlook',
  ...
  requests: {
    ...
    showingPreviousDataFor: 'Showing previously loaded data for {{date}}',
    showingPreviousData: 'Showing previously loaded data while current filters update',
    showingPreviousDataFrom: 'Showing previously loaded data: {{source}}',
  },
  approvals: {
  ...
  legal: {
    ...
    privacyPolicy: {
      ...
      introductionBody: 'Dallah Albaraka Group ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Visitor Management System (VMS) mobile application.',
      infoCollect: '2. Information We Collect',
      personalInfo: 'Personal Information',
      personalInfoBody: '\u2022 Full name and contact information (email address, phone number)\n\u2022 Profile photograph (optional)\n\u2022 Company/organization affiliation\n\u2022 Government-issued identification details (for visitor verification)\n\u2022 Vehicle information (license plate, make, model) for parking and valet services',
      technicalInfo: 'Technical Information',
      technicalInfoBody: '\u2022 Device identifiers for push notification delivery\n\u2022 App usage data and interaction logs\n\u2022 Crash reports and diagnostic data (via Firebase Crashlytics)\n\u2022 IP address and general location data',
      howWeUse: '3. How We Use Your Information',
      howWeUseBody: 'We use the collected information to:\n\n\u2022 Manage visitor registrations, approvals, and check-ins\n\u2022 Provide parking and valet services\n\u2022 Send push notifications about visit status updates and approvals\n\u2022 Manage meeting room and buffet bookings\n\u2022 Authenticate and authorize users based on their assigned roles\n\u2022 Improve application performance and user experience\n\u2022 Ensure the security of our facilities and systems',
      dataSharing: '4. Data Sharing and Disclosure',
      dataSharingBody: 'We do not sell your personal information. We may share your data with:\n\n\u2022 Authorized personnel within Dallah Albaraka Group who need access for visitor management purposes\n\u2022 Service providers who assist in operating the VMS (e.g., cloud hosting, push notification services)\n\u2022 Law enforcement or regulatory authorities when required by applicable law',
      dataSecurity: '5. Data Security',
      dataSecurityBody: 'We implement appropriate technical and organizational measures to protect your personal information, including encryption in transit (TLS/SSL), secure authentication with JWT tokens, and role-based access controls. However, no method of electronic transmission or storage is 100% secure.',
      dataRetention: '6. Data Retention',
      dataRetentionBody: 'We retain your personal information only for as long as necessary to fulfill the purposes for which it was collected, comply with legal obligations, resolve disputes, and enforce our agreements. Visit records may be retained for security audit purposes as required by applicable regulations.',
      yourRights: '7. Your Rights',
      yourRightsBody: 'You have the right to:\n\n\u2022 Access and review your personal information\n\u2022 Request correction of inaccurate data\n\u2022 Request deletion of your account and associated data\n\u2022 Opt out of non-essential push notifications\n\u2022 Withdraw consent for optional data processing',
      thirdParty: '8. Third-Party Services',
      thirdPartyBody: 'Our application uses the following third-party services:\n\n\u2022 Firebase Cloud Messaging (FCM) for push notifications\n\u2022 Firebase Crashlytics for crash reporting and diagnostics\n\u2022 Microsoft Azure Active Directory for single sign-on authentication\n\nEach service has its own privacy policy governing data processing.',
      childrenPrivacy: '9. Children\'s Privacy',
      childrenPrivacyBody: 'This application is designed for business use and is not intended for individuals under the age of 18. We do not knowingly collect personal information from children.',
      changesToPolicy: '10. Changes to This Policy',
      changesToPolicyBody: 'We may update this Privacy Policy from time to time. We will notify you of any material changes by posting the updated policy within the application. Your continued use of the VMS after such modifications constitutes your acknowledgment of the modified policy.',
      contactUs: '11. Contact Us',
      contactUsBody: 'If you have questions or concerns about this Privacy Policy or our data practices, please contact us at:\n\nDallah Albaraka Group\nEmail: support@dallahdigital.com',
    },
    termsConditions: {
      acceptance: '1. Acceptance of Terms',
      acceptanceBody: 'By accessing or using the Dallah Albaraka Visitor Management System ("VMS" or "the Application"), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, you must not use the Application.',
      description: '2. Description of Service',
      descriptionBody: 'The VMS is a corporate visitor management application that enables organizations to manage visitor registrations, approvals, check-ins, parking, valet services, meeting room bookings, and buffet services. The Application supports multiple user roles including employees, managers, receptionists, security personnel, and administrators.',
      userAccounts: '3. User Accounts and Access',
      userAccountsBody: '\u2022 Access to the Application is provided by your organization\'s administrator\n\u2022 You are responsible for maintaining the confidentiality of your account credentials\n\u2022 You must not share your login credentials with unauthorized individuals\n\u2022 You must immediately notify your administrator of any unauthorized use of your account\n\u2022 Access privileges are determined by your assigned role and may be modified by administrators at any time',
      acceptableUse: '4. Acceptable Use',
      acceptableUseBody: 'You agree to use the Application only for its intended purposes. You must not:\n\n\u2022 Use the Application for any unlawful purpose\n\u2022 Attempt to gain unauthorized access to any part of the system\n\u2022 Submit false or misleading information\n\u2022 Interfere with or disrupt the Application\'s functionality\n\u2022 Attempt to reverse engineer, decompile, or disassemble the Application\n\u2022 Use automated tools or scripts to access or extract data from the Application',
      visitorObligations: '5. Visitor Obligations',
      visitorObligationsBody: 'Visitors using the Application to accept invitations or check in must:\n\n\u2022 Provide accurate personal and identification information\n\u2022 Comply with all facility security requirements\n\u2022 Follow check-in and check-out procedures\n\u2022 Adhere to all applicable facility rules and regulations\n\u2022 Provide accurate vehicle information if requesting parking or valet services',
      intellectualProperty: '6. Intellectual Property',
      intellectualPropertyBody: 'The Application, including its design, features, content, and underlying technology, is owned by Dallah Albaraka Group and is protected by intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Application without prior written consent.',
      dataPrivacy: '7. Data and Privacy',
      dataPrivacyBody: 'Your use of the Application is also governed by our Privacy Policy, which describes how we collect, use, and protect your personal information. By using the Application, you consent to the data practices described in the Privacy Policy.',
      pushNotifications: '8. Push Notifications',
      pushNotificationsBody: 'The Application may send push notifications related to visit approvals, check-in reminders, and other operational updates. You can manage your notification preferences within the Application settings. Critical security notifications may not be disabled.',
      serviceAvailability: '9. Service Availability',
      serviceAvailabilityBody: 'We strive to maintain continuous availability of the Application but do not guarantee uninterrupted access. The Application may be temporarily unavailable due to maintenance, updates, or circumstances beyond our control. We reserve the right to modify, suspend, or discontinue any feature of the Application at any time.',
      limitation: '10. Limitation of Liability',
      limitationBody: 'To the maximum extent permitted by applicable law, Dallah Albaraka Group shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Application. Our total liability for any claims related to the Application shall not exceed the amount you paid for access to the Application.',
      indemnification: '11. Indemnification',
      indemnificationBody: 'You agree to indemnify and hold harmless Dallah Albaraka Group, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your violation of these Terms and Conditions or your misuse of the Application.',
      governingLaw: '12. Governing Law',
      governingLawBody: 'These Terms and Conditions shall be governed by and construed in accordance with the laws of the Kingdom of Saudi Arabia. Any disputes arising from these terms shall be subject to the exclusive jurisdiction of the courts of the Kingdom of Saudi Arabia.',
      changesToTerms: '13. Changes to Terms',
      changesToTermsBody: 'We reserve the right to update or modify these Terms and Conditions at any time. Material changes will be communicated through the Application. Your continued use of the Application after such modifications constitutes acceptance of the updated terms.',
      contactInfo: '14. Contact Information',
      contactInfoBody: 'For questions about these Terms and Conditions, please contact:\n\nDallah Albaraka Group\nEmail: support@dallahdigital.com',
    },
  },
};
