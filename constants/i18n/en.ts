...
export const en: TranslationKeys = {
  ...
  visitorInvite: {
    ...
    noParking: 'I do not need parking',
    needsParking: 'I need parking',
    needsParkingInfoLater: 'I need parking (info later)',
    licensePlate: 'License Plate',
    carModel: 'Car Model',
    carColor: 'Car Color',
    noParkingDescription: 'Select this if you will not be driving',
    needsParkingDescription: 'Provide your car details for parking assignment',
    needsParkingInfoLaterDescription: 'Choose this if you will provide car details later',
    enterLicensePlate: 'Enter license plate number',
    enterCarModel: 'e.g. Toyota Camry',
    enterCarColor: 'e.g. White, Black, Silver',
  },
  calendar: {
